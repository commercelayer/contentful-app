...
export declare const createWithId: (http: AxiosInstance, params: GetWebhookParams, rawData: CreateWebhooksProps, headers?: AxiosRequestHeaders | undefined) => Promise<WebhookProps>;
