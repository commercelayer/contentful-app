...
export declare type WorkflowStepPermissionActors = 'all' | NonEmptyArray<Link<'User'> | Link<'Team'>>;
...
export declare type WorkflowStepEmailActionRecipient = string | Link<'User'> | Link<'Team'>;
export declare type WorkflowStepEmailAction = {
    type: 'email';
    configuration: {
        recipients: WorkflowStepEmailActionRecipient[];
    };
};
export declare type WorkflowStepTaskAction = {
    type: 'task';
    configuration: {
...
export declare type WorkflowStepAppAction = {
    type: 'app';
    appId: string;
    appActionId: string;
    configuration?: {
